...
const SLOT_STORAGE_KEY = "capd-ui-preview:home-a:slots:v1";
const ACTIVE_SESSION_STORAGE_KEY = "capd-ui-preview:home-a:active-session:v1";
...
export function createPreviewSessionId(slotIndex: number): string {
  return `ses_preview_${slotIndex + 1}_${Date.now()}`;
}
