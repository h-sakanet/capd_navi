...
| ID | 観点 | 前提 | 操作 | 期待結果 |
|---|---|---|---|---|
| AT-UI-HOME-001 | Home A表示確認 | プレビュー画面あり | 画面確認 | A案確定仕様と一致 |
| AT-UI-HOME-002 | Home A初期状態 | Home A初回表示 | 画面確認 | #1〜#4が未登録(`+`) |
| AT-UI-SESSION-001 | Session A表示確認 | プレビュー画面あり | 画面確認 | A案確定仕様と一致 |
