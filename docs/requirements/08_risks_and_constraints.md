...
| R-006 | iPhone通知制約 | 補助通知が不達になり見逃し率上昇 | Mac主チャネル固定 + 段階再通知 + 毎日30秒テスト |
...
| R-014 | 毎日テスト未実施 | iPhone補助不達を事前検知できない | 当日最初のタイマー前に30秒テストを必須運用化 |
...
|---|---|---|---|
| 寝ている | iPhone補助 | Mac通知後、未確認時にiPhoneへエスカレーション | iPhone設定依存があるため毎日30秒テストが必要 |
