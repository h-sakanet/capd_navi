...
flowchart LR
  ...
  subgraph SCR["Screens"]
    N60["SCR-HOME-001 Home"]
    N61["SCR-HOME-SETUP-001 スロット設定"]
    N62["SCR-HOME-START-CONFIRM-001 開始確認"]
    N63["SCR-HOME-VIEW-CONFIRM-001 閲覧専用確認"]
    N64["SCR-SESSION-001 Session"]
  end
  subgraph FC["Forms"]
