...
flowchart LR
  ...
  subgraph SCR["Screens"]
    N45["SCR-HISTORY-DETAIL-001 記録詳細"]
    N46["SCR-HOME-001 Home"]
    N47["SCR-HOME-START-CONFIRM-001 開始確認"]
    N48["SCR-HOME-VIEW-CONFIRM-001 閲覧専用確認"]
    N49["SCR-SESSION-001 Session"]
    N50["SCR-SESSION-RECORD-001 記録入力"]
  end
