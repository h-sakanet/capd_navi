# SCR-HOME-START-CONFIRM-001 マップ

```mermaid
flowchart LR
  %% SCR-HOME-START-CONFIRM-001
  ...
  subgraph SCR["Screens"]
    N17["SCR-HOME-001 Home"]
    N18["SCR-HOME-SETUP-001 スロット設定"]
    N19["SCR-HOME-START-CONFIRM-001 開始確認"]
    N20["SCR-HOME-VIEW-CONFIRM-001 閲覧専用確認"]
    N21["SCR-SESSION-001 Session"]
  end
