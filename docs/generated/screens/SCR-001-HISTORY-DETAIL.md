# SCR-001-HISTORY-DETAIL マップ

```mermaid
flowchart LR
  %% SCR-001-HISTORY-DETAIL
  ...
  subgraph SCR["Screens"]
    N43["SCR-001-HISTORY 記録一覧"]
    N44["SCR-001-HISTORY-DETAIL 記録詳細"]
    N45["SCR-001-HISTORY-PHOTO 写真詳細"]
    N46["SCR-001-HOME Home"]
    N47["SCR-001-HOME-SUMMARY 全体サマリ"]
    N48["SCR-001-SESSION Session"]
    N49["SCR-001-SESSION-RECORD 記録入力"]
  end
