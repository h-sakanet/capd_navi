...
flowchart LR
  ...
  subgraph SCR["Screens"]
    N68["SCR-HISTORY-001 記録一覧"]
    N69["SCR-HISTORY-DETAIL-001 記録詳細"]
    N70["SCR-HISTORY-PHOTO-001 写真詳細"]
    N71["SCR-HOME-001 Home"]
    N72["SCR-HOME-SETUP-001 スロット設定"]
    N73["SCR-HOME-START-CONFIRM-001 開始確認"]
    N74["SCR-HOME-VIEW-CONFIRM-001 閲覧専用確認"]
    N75["SCR-MAC-IMPORT-001 CSV取込I/F"]
    N76["SCR-SESSION-001 Session"]
    N77["SCR-SYNC-STATUS-001 同期状態表示"]
  end
