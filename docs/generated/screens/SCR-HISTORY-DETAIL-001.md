# SCR-HISTORY-DETAIL-001 マップ

```mermaid
flowchart LR
  %% SCR-HISTORY-DETAIL-001
  ...
  subgraph SCR["Screens"]
    N43["SCR-HISTORY-001 記録一覧"]
    N44["SCR-HISTORY-DETAIL-001 記録詳細"]
    N45["SCR-HISTORY-PHOTO-001 写真詳細"]
    N46["SCR-HOME-001 Home"]
    N47["SCR-HOME-SUMMARY-001 全体サマリ"]
    N48["SCR-SESSION-001 Session"]
    N49["SCR-SESSION-RECORD-001 記録入力"]
  end
