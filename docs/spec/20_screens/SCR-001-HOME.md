...
## 3. UIワイヤー・レイアウト制約
- 参照: `../../../requirements/06_ui_wireframes_ab.md` 5章。
...
| ACT-003-HOME | 対象スロット登録済み | なし | SCR-004-HOME-VIEW-CONFIRM | なし |
| ACT-004-HOME | `displayStatus!=completed` かつ進行中なし | なし | SCR-002-HOME-SETUP | 編集不可メッセージ |
...
## 11. 参照リンク
- FR: FR-004A, FR-005, FR-005A, FR-006, FR-007, FR-008, FR-009A〜FR-009H, FR-016, FR-017, FR-018, FR-019, FR-086, FR-088
